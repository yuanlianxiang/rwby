    ...
    <table class="table table-hover table-striped">
        ...
        <tbody>
            <?php if(is_array($leave)): foreach($leave as $key=>$v): ?><tr>
                    ...
                    <?php if($v["state"] == 1): ?><td><a href="<?php echo U('leave/approve?id='); echo ($v["id"]); ?>" ><span class="label label-success">已批准</span></a> </td>
                        <?php else: ?>
                        <td><a href="<?php echo U('leave/approve?id='); echo ($v["id"]); ?>" ><span class="label label-danger">不批准</span></a></td><?php endif; ?>
