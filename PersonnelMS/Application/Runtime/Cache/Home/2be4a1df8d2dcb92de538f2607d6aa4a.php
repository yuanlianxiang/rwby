...
<div id="page-wrapper">
    ...
    <?php if(is_array($consumer)): foreach($consumer as $key=>$v): ?><div class="row">
            <div class="col-xs-4 feature">
                <div class="product-container">
                    <div class="name">个 人 信 息</div>
                    <div class="intro">
                        <span class="label col-md-4">编 号</span>
                        <span class="percent col-md-6"><?php echo ($v["id"]); ?></span>
                    </div>
                    <div class="intro">
                        <span class="label col-md-4">姓 名</span>
                        <span class="percent col-md-6"><?php echo ($v["username"]); ?></span>
                    </div>
                    <div class="intro">
                        <span class="label col-md-4">性 别</span>
                        <span class="percent col-md-6"><?php echo ($v["sex"]); ?></span>
                    </div>
                    <div class="intro">
