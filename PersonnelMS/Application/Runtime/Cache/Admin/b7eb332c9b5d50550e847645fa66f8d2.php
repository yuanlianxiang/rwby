...
<div id="page-wrapper">
    ...
    <div class="content">
        <div class="content-top">
            <div class="col-md-4">
                <button type="button" class="btn btn-info" onclick="addConsumer();">添加</button>
                <button type="button" class="btn btn-info"><a href="<?php echo U('consumer/index');?>" class="col-md-2">全部</a></button>
            </div>
            <div class="col-md-4" style="float:right;">
                <form action="<?php echo U('consumer/index');?>" method="post">
      ...
      <table class="table table-hover table-striped">
        ...
        <tbody>
            <?php if(is_array($consumer)): foreach($consumer as $key=>$v): ?><tr>
                    <td><?php echo ($v["id"]); ?></td>
                    ...
                    <td><a style="margin-right: 10px;"><span class="label label-info" onclick="updateConsumer(<?php echo ($v["id"]); ?>)">编辑</span></a>  <a href="<?php echo U('consumer/delete?id='); echo ($v["id"]); ?>" style="color:red;" onclick="javascript:return del('删除后用户将不能登陆!\n\n请确认!!!');"><span class="label label-warning">删除</span></a></td>
...
<div class="consumer-add" style="display: none;margin-top: 20px;">
	<form id="addConsumerForm" class="form-horizontal"  action="<?php echo U('consumer/add');?>" method="post">
		<div class="form-group">
...
<script type="text/javascript">
	function addConsumer(){
		$("#department").empty();
		var date=new Date();
		var url = "<?php echo U('Consumer/add');?>";
...
<div class="consumer-update" style="display: none;margin-top: 20px;">
	<form id="updateConsumerForm" class="form-horizontal" action="<?php echo U('consumer/update');?>" method="post">
		<div class="form-group">
			<label class="col-md-4 control-label">姓名</label>
			<div class="col-md-6">
